...
{
    public delegate void TablonMirado();
    public static event TablonMirado OnTablonMirado;
    public delegate void MacetaMirada();
    public static event MacetaMirada OnMacetaMirada;
    /// <summary>
    ...
    public void OnPointerEnter()
    {
        if (this.tag == "Maceta")
        {
            OnMacetaMirada.Invoke();
        }
        if (this.tag == "Tablon") {
            OnTablonMirado.Invoke();
        }
